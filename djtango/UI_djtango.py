...
""))
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/img/clear-button.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButtonClearFilter.setIcon(icon3)
...
""))
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8("img/hide-right.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButtonHideDest.setIcon(icon4)
...
""))
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8("img/hide-left.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButtonHideSource.setIcon(icon5)
...
""))
        ...
        self.pushButtonMilongaClear.setIcon(icon3)
...
""))
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(":/img/load-milonga-button.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButtonLoadMilonga.setIcon(icon6)
...
""))
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8(":/img/info-button.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButtonInfoMilonga.setIcon(icon7)
...
""))
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(_fromUtf8(":/img/save-milonga-button.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButtonSaveMilonga.setIcon(icon8)
...
""))
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(_fromUtf8(":/img/trash-button.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButtonDeleteMilonga.setIcon(icon9)
