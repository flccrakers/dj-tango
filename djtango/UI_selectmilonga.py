...
class Ui_selectmilonga(object):
    def setupUi(self, selectmilonga):
        selectmilonga.setObjectName(_fromUtf8("selectmilonga"))
        ...
        selectmilonga.setStyleSheet(_fromUtf8("QDialog{\n"
"    background-color: rgb(42,42,42)\n"
"}"))
        self.verticalLayout = QtGui.QVBoxLayout(selectmilonga)
        self.verticalLayout.setObjectName(_fromUtf8("verticalLayout"))
        self.label = QtGui.QLabel(selectmilonga)
...
"}"))
        ...
        self.listWidgetMilongas = QtGui.QListWidget(selectmilonga)
        ...
        self.listWidgetMilongas.setStyleSheet(_fromUtf8("QListWidget{\n"
"    background-color: rgb(42,42,42);\n"
"    color: white;\n"
"    \n"
"}\n"
...
"}"))
        self.listWidgetMilongas.setObjectName(_fromUtf8("listWidgetMilongas"))
        self.verticalLayout.addWidget(self.listWidgetMilongas)
        self.buttonBox = QtGui.QDialogButtonBox(selectmilonga)
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(42, 42, 42))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Base, brush)
...
"}"))
        ...
        QtCore.QObject.connect(self.buttonBox, QtCore.SIGNAL(_fromUtf8("accepted()")), selectmilonga.accept)
        QtCore.QObject.connect(self.buttonBox, QtCore.SIGNAL(_fromUtf8("rejected()")), selectmilonga.reject)
        QtCore.QMetaObject.connectSlotsByName(selectmilonga)

    def retranslateUi(self, selectmilonga):
        selectmilonga.setWindowTitle(_translate("selectmilonga", "Dialog", None))
        self.label.setText(_translate("selectmilonga", "Select a milonga", None))
